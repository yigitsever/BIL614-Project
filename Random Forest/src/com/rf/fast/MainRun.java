...
public class MainRun {
	...
	public ArrayList<ArrayList<String>>  RFRunner(String traindata, String testdata,String DataInfo,String foraccuracy,String withthreads,int numTrees, int numThreads,int numAttris,int Ms)
	{
		...
		else if (withthreads.toLowerCase().toCharArray()[0] == 'y')
	...
	public static void main(String[] args) {
		...
		System.out.println(RFC.results);
	}
}
