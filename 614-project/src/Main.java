...
public class Main {
	...
	public static void main(String[] args) {
		...
		//CHECK using output file create RF decision tree
		//CHECK using RF find popular or not
		
		Manager man = new Manager("/Users/erantoker/Documents/workspace/614-project/popular/","/Users/erantoker/Documents/workspace/614-project/test/",50);
		man.execute(true);
